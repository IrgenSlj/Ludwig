# Ludwig Blender realism toolkit — SALVAGED from the mesh era for the P1 render backend.
# Status: not yet wired. backends/render.py imports this LAZILY (it needs bpy / a BYO Blender),
# so importing the `backends` package must never pull this in. It is a derived-preview backend
# (BRIEF §6: render hosts the DEMOTED, soft, pairwise vision critic) — never the source of truth.
#
